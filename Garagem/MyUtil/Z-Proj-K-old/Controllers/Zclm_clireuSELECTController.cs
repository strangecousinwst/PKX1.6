...
namespace KRONOS.Controllers
{
    ...
    public class Zclm_clireuSELECTController : Controller
    {
        ...
        public ActionResult Index(string str_cli_id_drop)
        {
            ...
            Session["clinadrop"] = (Session["clinadrop"] == null) ? "5" : Session["clinadrop"];
            //se a string que vem da drop está vazia, ficará com o cliente que estiver na session:
            str_cli_id_drop = (str_cli_id_drop != null) ? str_cli_id_drop : Session["clinadrop"].ToString();
        ...
        public ActionResult Edit(int? id)
        {
            ...
            Session["clinadrop"] = clm_clireu.cliID.ToString(); 
